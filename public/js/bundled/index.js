...
/* eslint-disable */ // This is the entry file for front-end: Get data from user interface and then delegate the action
...
const displayMap = (locations)=>{
    mapboxgl.accessToken = "pk.eyJ1IjoiYWlyY2hhbyIsImEiOiJjbDk1eXgyaDIwYjZiM29tcWpmZm95ajZzIn0.smupvOvQP-ApRFTRN2KM_A";
...
const logout = async ()=>{
    try {
        ...
        if (res.data.status === "success") location.reload(true); // reload from the server rather than the browser cache
    } catch (err) {
...
const bookTour = async (tourId)=>{
    try {
        const stripe = Stripe("pk_test_51Lt8jwJftMOuYWMuPQhuRBufKqrlRwPxS5Jpyj4E67uXs26nUmkPVeRBbCdI3BxGg5xFp8BBlUSxzeyZPq2Pvadi00UVCNW2sC");
